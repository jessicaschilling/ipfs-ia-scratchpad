<template>
  <footer class="bg-washed-blue pa4 pv5-l">
    <div class="mw8 center">
      ...
      <div class="flex items-center mb4 mt3 justify-between">
        <div class="flex">
          <div class="mr4"><a href="/blog-news">Blog &amp; news</a></div>
